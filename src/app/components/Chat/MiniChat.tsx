		...
		>
			...
			>
				{isDm ? (
					...
					<div className="w-6 h-6 rounded bg-brand-600/20 flex items-center justify-center shrink-0">
				...
				<>
					...
					<div className="shrink-0 px-2 py-2 border-t border-slate-800/60">
						<input
							...
							className="w-full px-3 py-2 bg-slate-800/60 border border-slate-700/40 rounded-full text-sm text-white placeholder-slate-500 focus:outline-none focus:border-brand-500/40"
						/>
					</div>
				</>
			)}
