						...
						<DialogPanel className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl overflow-hidden">
							...
							<div className="flex gap-1 px-5 pt-4">
								<button
									...
									className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer ${
										mode === 'dm' ? 'bg-brand-600/15 text-brand-300' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'
									}`}
								>
								...
								<button
									...
									className={`flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-medium transition cursor-pointer ${
										mode === 'group' ? 'bg-brand-600/15 text-brand-300' : 'text-slate-400 hover:text-white hover:bg-slate-800/50'
									}`}
								>
							...
							{mode === 'group' && (
								<div className="px-5 pt-3 space-y-2">
									<input
										...
										className="w-full px-3 py-2 bg-slate-800/50 border border-slate-700/50 rounded-lg text-sm text-white placeholder-slate-500 focus:outline-none focus:border-brand-500/50"
									/>
									<input
										type="text"
							...
							<div className="px-5 py-4 border-t border-slate-800 flex justify-end gap-2">
								...
								<button
									...
									className="px-4 py-2 rounded-lg text-sm font-medium bg-brand-600 text-white hover:bg-brand-500 disabled:opacity-50 disabled:cursor-not-allowed transition cursor-pointer"
								>
