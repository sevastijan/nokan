			...
			<div className="flex items-end gap-1.5 px-4 py-3">
				...
				<div className="flex-1 relative">
					<textarea
						...
						rows={1}
						className="w-full px-4 py-2.5 bg-slate-800/60 border border-slate-700/40 rounded-xl text-sm text-white placeholder-slate-500 resize-none focus:outline-none focus:border-brand-500/40 focus:bg-slate-800/80 transition-colors"
					/>
				</div>
