    ...
    <div className="mt-6">
      ...
      {subtasks.length === 0 && !isAddingNew && (
        <div className="text-center py-4 text-slate-400 text-sm">
          No subtasks yet. Add one to break down this story.
        </div>
      )}
            ...
            <div className="flex items-center gap-2">
              <input
                ...
                className="
                  ...
                  rounded-lg text-slate-200 text-sm
              ...
              <button
                ...
                disabled={isAdding}
                className="
                  px-3 py-2 bg-slate-600 hover:bg-slate-500
                  text-slate-200 text-sm font-medium rounded-lg
                  transition-colors duration-150
                "
              >
                Cancel
