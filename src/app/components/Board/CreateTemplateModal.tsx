                              ...
                              <div className="space-y-4">
                                   ...
                                   <div>
                                        ...
                                        <textarea
                                             ...
                                             className="w-full bg-slate-900/50 text-white border border-slate-700/50 rounded-lg p-3 focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 resize-none placeholder-slate-500 transition-colors"
                                             rows={3}
                                   ...
                                   <div>
                                        <div className="flex items-center justify-between mb-3">
                                             ...
                                             <button onClick={addColumn} className="flex items-center gap-2 text-brand-400 hover:text-brand-300 transition-colors text-sm">
                                                  ...
                                                  <div key={column.id} className="bg-slate-800/60 border border-slate-700/30 rounded-lg p-3">
                                                       <div className="flex items-center gap-3 mb-2">
                                                            ...
                                                            <input
                                                                 ...
                                                                 className="flex-1 bg-slate-900/50 text-white border border-slate-700/50 rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500/50 placeholder-slate-500 transition-colors"
                                                       ...
                                                       <div className="ml-8">
                                                            <div className="flex items-center gap-2 mb-1">
                                                                 ...
                                                                 <button onClick={() => addTask(column.id)} className="text-xs text-brand-400 hover:text-brand-300 flex items-center gap-1 transition-colors">
                                                                 ...
                                                                 {column.tasks.map((task, tIdx) => (
                                                                      <div key={task.id} className="flex items-center gap-2 bg-slate-900/40 border border-slate-700/30 rounded-lg p-2">
                                                                           ...
                                                                           <input
                                                                                ...
                                                                                className="flex-1 bg-slate-800/50 text-white border border-slate-700/50 rounded px-2 py-1 text-xs focus:outline-none focus:ring-1 focus:ring-brand-500/50 placeholder-slate-500 transition-colors"
