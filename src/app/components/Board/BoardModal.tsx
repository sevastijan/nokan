...
const BoardModal = ({
  ...
  const getUserAvatar = (user: User) => {
    ...
    const initials = (user.name || user.email || "?")
      ...
      .toUpperCase();
    return (
      <div className="w-8 h-8 rounded-full bg-brand-600/30 flex items-center justify-center text-xs font-medium text-brand-300">
        {initials}
      </div>
    );
  };
                  ...
                  <div>
                    ...
                    <div className="flex gap-1 mb-2 bg-slate-800/60 rounded-lg p-1">
                      ...
                      >
                        ...
                        {selectedTeamIds.length > 0 && (
                          <span className="ml-1 text-xs bg-brand-600/30 text-brand-300 px-1.5 py-0.5 rounded-full">
                    ...
                    <div className="relative mb-2">
                      ...
                      <input
                        ...
                        className="w-full bg-slate-900/50 text-white border border-slate-700/50 rounded-lg pl-9 pr-3 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 placeholder-slate-500 transition-colors"
                        placeholder={
                          memberTab === "users"
                            ...
                            return (
                              <div
                                ...
                                className={`flex items-center gap-3 px-3 py-2 rounded-lg transition-colors ${
                                  isCreator
                                    ? "bg-brand-600/10 cursor-default"
                                    : isSelected
                                    ? "bg-brand-600/15 hover:bg-brand-600/20 cursor-pointer"
                              ...
                              >
                                ...
                                {isCreator ? (
                                  ...
                                  <button
                                    ...
                                    className="w-7 h-7 rounded-full bg-slate-700/50 flex items-center justify-center hover:bg-brand-600/20 transition-colors"
                                  >
                                    <UserPlus
                                      size={14}
