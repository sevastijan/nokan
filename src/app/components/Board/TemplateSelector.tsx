                    ...
                    {isOpen && !loading && !error && (
                         ...
                         >
                              <button
                                   ...
                                   className="w-full p-3 text-left hover:bg-slate-800/60 transition-colors border-b border-slate-700/30 flex items-center gap-2 text-brand-400"
                              >
                                   <Plus size={16} />
                                   <div>
                              ...
                              {templates.map((template) => (
                                   <div
                                        ...
                                        className={`p-3 hover:bg-slate-800/60 transition-colors cursor-pointer flex items-center justify-between ${
                                             selectedTemplate?.id === template.id ? 'bg-brand-600/10' : ''
                                        }`}
                                        onClick={() => {
                                   ...
                                   >
                                        <div className="flex-1">
                                             <div className="font-medium flex items-center gap-2">
                                                  {template.name}
                                                  {!template.is_custom && <span className="text-xs bg-brand-600/20 text-brand-400 px-2 py-0.5 rounded">{t('templates.default')}</span>}
                                             </div>
