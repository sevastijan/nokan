               ...
               <div className="flex flex-col sm:flex-row gap-3 items-stretch sm:items-center w-full sm:w-auto">
                    <div className="relative flex-1 sm:w-64">
                         ...
                         <input
                              ...
                              className="pl-10 pr-4 py-2 bg-slate-700/60 border border-slate-600/50 rounded-xl text-slate-200 w-full focus:outline-none focus:ring-2 focus:ring-blue-500 transition"
                         />
                    </div>
