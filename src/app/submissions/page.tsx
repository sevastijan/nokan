...
const priorityConfig: Record<string, { labelKey: string; color: string; bg: string; border: string; dot: string }> = {
     low: { labelKey: 'submissions.priorityLow', color: 'text-brand-300', bg: 'bg-brand-500/10', border: 'border-brand-500/20', dot: 'bg-brand-400' },
                         ...
                         <div className="flex items-start justify-between">
                              ...
                              {!isAdmin && (
                                   <motion.button
                                        ...
                                        className="flex items-center gap-2 px-5 py-2.5 bg-brand-600 hover:bg-brand-500 text-white text-sm font-medium rounded-xl shadow-lg shadow-brand-600/20 transition-colors cursor-pointer"
                                   >
                                                                                     ...
                                                                                     {editingId === sub.submission_id && !isOwner ? (
                                                                                          <div className="space-y-3" onClick={(e) => e.stopPropagation()}>
                                                                                               <input
                                                                                                    ...
                                                                                                    className="w-full px-3 py-2 bg-slate-700/60 border border-slate-600/50 rounded-lg text-sm text-white focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 transition-all"
                                                                                               />
                                                                                               <textarea
                                                                                                    value={editForm.description}
                                                                                                    onChange={(e) => setEditForm({ ...editForm, description: e.target.value })}
                                                                                                    rows={3}
                                                                                                    className="w-full px-3 py-2 bg-slate-700/60 border border-slate-600/50 rounded-lg text-sm text-white resize-none focus:outline-none focus:ring-2 focus:ring-brand-500/50 focus:border-brand-500/50 transition-all"
                                                                                               />
                                                                                                    ...
                                                                                                    {!isOwner && (
                                                                                                         ...
                                                                                                         >
                                                                                                              <button
                                                                                                                   ...
                                                                                                                   className="p-1.5 rounded-md text-slate-400 hover:text-brand-400 hover:bg-brand-500/10 transition-all cursor-pointer"
                                                                                                                   title={t('common.edit')}
                                                                                                              >
