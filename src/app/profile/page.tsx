     ...
     <div className="flex items-center justify-between py-3 border-b border-slate-700/30 last:border-0 gap-4">
          ...
          <button
               ...
               className={`relative inline-flex h-7 w-12 items-center rounded-full transition-colors flex-shrink-0 cursor-pointer ${
                    enabled ? 'bg-brand-600 shadow-[0_0_8px_rgba(152,55,250,0.4)]' : 'bg-slate-600 hover:bg-slate-500'
               }`}
          >
...
const roleColors: Record<string, string> = {
     ...
     PROJECT_MANAGER: 'bg-brand-600/20 text-brand-300 border-brand-400/30',
                              ...
                              <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                                   ...
                                   <div className="lg:col-span-1 space-y-6">
                                        ...
                                        <div className="bg-gradient-to-br from-slate-800/60 via-slate-800/60 to-slate-800/40 border border-slate-700/50 rounded-2xl shadow-xl overflow-hidden">
                                             <div className="h-16 sm:h-20 bg-gradient-to-r from-brand-600/20 via-brand-600/20 to-pink-600/20 relative overflow-hidden">
                                                  <div className="absolute inset-0 bg-gradient-to-b from-transparent to-slate-900/80" />
                                             </div>

                                             <div className="px-4 sm:px-6 pb-6 -mt-10 sm:-mt-12 flex flex-col items-center text-center">
                                                  <div className="relative group mb-3">
                                                       <div className="absolute -inset-1 bg-gradient-to-r from-brand-600 via-brand-600 to-pink-600 rounded-full opacity-75 group-hover:opacity-100 blur transition duration-300" />
                                                       <div className="relative">
                                                       ...
                                                       {isEditingName ? (
                                                            <div className="flex items-center gap-2 animate-in fade-in slide-in-from-top-2 duration-200">
                                                                 <input
                                                                      ...
                                                                      className="flex-1 px-3 py-1.5 bg-slate-800/80 border border-slate-600 rounded-lg text-white text-sm focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all"
                                                                      placeholder={t('profile.yourName')}
                                                                      autoFocus
                                                                 />
                                                                 <button
                                                                      onClick={handleNameSave}
                                                                      className="p-2 bg-gradient-to-r from-brand-600 to-brand-700 hover:from-brand-700 hover:to-brand-800 rounded-lg transition-all transform hover:scale-105 active:scale-95 shadow-lg"
                                                                 >
                                                            ...
                                                            <div className="group/name cursor-pointer" onClick={() => setIsEditingName(true)}>
                                                                 <div className="flex items-center justify-center gap-2 px-3 py-1.5 rounded-lg hover:bg-slate-800/50 transition-all">
                                                                      ...
                                                                      <div className="p-1 rounded-md bg-slate-800/50 group-hover/name:bg-slate-800 transition-all">
                                                                           <Pencil className="w-3 h-3 text-slate-400 group-hover/name:text-brand-400 transition-colors" />
                                                                      </div>
                                                                 </div>
                                                            </div>
                                                       )}
                                   ...
                                   <div className="lg:col-span-2 space-y-6">
                                        ...
                                        <div className="bg-slate-800/60 border border-slate-700/50 rounded-2xl shadow-xl p-6 sm:p-8">
                                             {/* Header */}
                                             <div className="flex items-center gap-3 mb-6">
                                                  <div className="w-10 h-10 bg-gradient-to-r from-brand-500 to-brand-500 rounded-xl flex items-center justify-center flex-shrink-0">
