    ...
    <Sonner
      ...
      toastOptions={{
        classNames: {
          ...
          actionButton:
            "group-[.toast]:bg-blue-600 group-[.toast]:text-white group-[.toast]:rounded-lg group-[.toast]:font-medium",
          cancelButton:
          ...
          info:
            "group-[.toaster]:border-blue-500/30 group-[.toaster]:bg-gradient-to-r group-[.toaster]:from-slate-800 group-[.toaster]:to-blue-950/30",
        },
      }}
      {...props}
    />
