...
function TicketForm({
  ...
  if (!boardInfo) {
    return /* @__PURE__ */ jsx("div", { style: defaultStyles.error, children: error || "Failed to load board info" });
  }
  if (!boardInfo.permissions.write) {
    return /* @__PURE__ */ jsx("div", { style: defaultStyles.error, children: "You don't have permission to create tickets" });
  }
  return /* @__PURE__ */ jsxs("form", { onSubmit: handleSubmit, style: defaultStyles.form, className, children: [
    error && /* @__PURE__ */ jsx("div", { style: defaultStyles.error, children: error }),
    success && /* @__PURE__ */ jsx("div", { style: defaultStyles.success, children: success }),
    /* @__PURE__ */ jsxs("div", { style: defaultStyles.fieldGroup, children: [
      /* @__PURE__ */ jsx("label", { style: defaultStyles.label, children: "Title *" }),
      /* @__PURE__ */ jsx(
        "input",
        {
          type: "text",
    ...
    /* @__PURE__ */ jsxs("div", { style: defaultStyles.fieldGroup, children: [
      /* @__PURE__ */ jsx("label", { style: defaultStyles.label, children: "Description" }),
      /* @__PURE__ */ jsx(
        "textarea",
        {
          value: description,
...
function TicketView({ client, ticketId, onClose, onUpdate, className, authorEmail }) {
  ...
  const [submittingComment, setSubmittingComment] = useState2(false);
  const [uploadingFile, setUploadingFile] = useState2(false);
  const [permissions, setPermissions] = useState2({ read: false, write: false, delete: false });
  ...
  if (loading) {
    return /* @__PURE__ */ jsx2("div", { style: styles.loading, children: "Loading ticket..." });
  }
  if (error && !ticket) {
    return /* @__PURE__ */ jsx2("div", { style: styles.error, children: error });
  }
  if (!ticket) {
  ...
  return /* @__PURE__ */ jsxs2("div", { style: styles.container, className, children: [
    /* @__PURE__ */ jsxs2("div", { style: styles.header, children: [
      ...
      onClose && /* @__PURE__ */ jsx2("button", { style: styles.closeButton, onClick: onClose, children: "\xD7" })
    ] }),
    /* @__PURE__ */ jsxs2("div", { style: styles.body, children: [
      error && /* @__PURE__ */ jsx2("div", { style: { ...styles.error, marginBottom: "16px" }, children: error }),
      /* @__PURE__ */ jsxs2("div", { style: styles.meta, children: [
        /* @__PURE__ */ jsx2(
          "span",
          {
            style: {
        ...
        ticket.completed && /* @__PURE__ */ jsx2("span", { style: { ...styles.badge, backgroundColor: "#d1fae5", color: "#059669" }, children: "Completed" })
      ] }),
      ticket.description && /* @__PURE__ */ jsx2("p", { style: styles.description, children: ticket.description }),
      /* @__PURE__ */ jsxs2("div", { style: { fontSize: "12px", color: "#6b7280", marginTop: "16px" }, children: [
        "Created: ",
        formatDate(ticket.created_at),
        ticket.updated_at !== ticket.created_at && /* @__PURE__ */ jsxs2(Fragment, { children: [
          " \xB7 Updated: ",
          formatDate(ticket.updated_at)
        ] })
      ] }),
      /* @__PURE__ */ jsxs2("div", { style: styles.section, children: [
        /* @__PURE__ */ jsxs2("h3", { style: styles.sectionTitle, children: [
          "Comments (",
          ticket.comments?.length || 0,
          ")"
        ] }),
        ticket.comments?.map((comment) => /* @__PURE__ */ jsxs2("div", { style: styles.comment, children: [
          /* @__PURE__ */ jsx2("div", { style: styles.commentContent, children: comment.content }),
          /* @__PURE__ */ jsxs2("div", { style: styles.commentMeta, children: [
            comment.author?.name || "Anonymous",
            " \xB7 ",
            formatDate(comment.created_at)
          ] })
        ] }, comment.id)),
        ticket.comments?.length === 0 && /* @__PURE__ */ jsx2("div", { style: { color: "#6b7280", fontSize: "14px" }, children: "No comments yet" }),
        permissions.write && /* @__PURE__ */ jsxs2("form", { onSubmit: handleAddComment, style: styles.form, children: [
          /* @__PURE__ */ jsx2(
            "input",
            {
              type: "text",
      ...
      /* @__PURE__ */ jsxs2("div", { style: styles.section, children: [
        ...
        ticket.attachments?.map((attachment) => /* @__PURE__ */ jsxs2("div", { style: styles.attachment, children: [
          /* @__PURE__ */ jsx2("span", { style: styles.attachmentIcon, children: "\u{1F4CE}" }),
          /* @__PURE__ */ jsx2("span", { children: attachment.file_name }),
          /* @__PURE__ */ jsx2("span", { style: styles.attachmentSize, children: formatFileSize(attachment.file_size) })
        ] }, attachment.id)),
        ticket.attachments?.length === 0 && /* @__PURE__ */ jsx2("div", { style: { color: "#6b7280", fontSize: "14px" }, children: "No attachments" }),
        permissions.write && /* @__PURE__ */ jsxs2("div", { style: { marginTop: "12px" }, children: [
          /* @__PURE__ */ jsx2(
            "input",
            {
              type: "file",
          ...
          /* @__PURE__ */ jsx2("label", { htmlFor: "file-upload", style: styles.fileButton, children: uploadingFile ? "Uploading..." : "+ Add Attachment" })
        ] })
      ] })
    ] })
  ] });
...
function TicketList({ client, onTicketClick, className }) {
  ...
  const [columnFilter, setColumnFilter] = useState3("");
  ...
  if (loading && tickets.length === 0) {
    return /* @__PURE__ */ jsx3("div", { style: styles2.loading, children: "Loading tickets..." });
  }
  return /* @__PURE__ */ jsxs3("div", { style: styles2.container, className, children: [
    /* @__PURE__ */ jsxs3("div", { style: styles2.header, children: [
      /* @__PURE__ */ jsxs3("h3", { style: styles2.title, children: [
        "Tickets (",
        total,
        ")"
      ] }),
      /* @__PURE__ */ jsx3("div", { style: styles2.filters, children: boardInfo && boardInfo.columns.length > 0 && /* @__PURE__ */ jsxs3(
        "select",
        {
          value: columnFilter,
          ...
          children: [
            /* @__PURE__ */ jsx3("option", { value: "", children: "All columns" }),
            boardInfo.columns.map((col) => /* @__PURE__ */ jsx3("option", { value: col.id, children: col.title }, col.id))
          ]
        }
      ) })
    ] }),
    ...
    tickets.length === 0 ? /* @__PURE__ */ jsx3("div", { style: styles2.empty, children: "No tickets found" }) : /* @__PURE__ */ jsx3("ul", { style: styles2.list, children: tickets.map((ticket) => {
      ...
      return /* @__PURE__ */ jsxs3(
        "li",
        {
          ...
          children: [
            /* @__PURE__ */ jsx3("div", { style: styles2.itemTitle, children: ticket.title }),
            /* @__PURE__ */ jsxs3("div", { style: styles2.itemMeta, children: [
              /* @__PURE__ */ jsx3(
                "span",
                {
                  style: {
              ...
              ticket.completed && /* @__PURE__ */ jsx3("span", { style: { color: "#059669" }, children: "\u2713 Completed" })
            ] })
          ]
        },
        ticket.id
    ...
    totalPages > 1 && /* @__PURE__ */ jsxs3("div", { style: styles2.pagination, children: [
      /* @__PURE__ */ jsx3(
        "button",
        {
          style: {
