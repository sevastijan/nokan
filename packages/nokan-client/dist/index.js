...
function TicketForm({
  ...
  return /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("form", { onSubmit: handleSubmit, style: defaultStyles.form, className, children: [
    ...
    !hideColumn && boardInfo.columns.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: defaultStyles.fieldGroup, children: [
    ...
    !hidePriority && boardInfo.priorities.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: defaultStyles.fieldGroup, children: [
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "select",
        {
          ...
          style: defaultStyles.select,
          children: boardInfo.priorities.map((p) => /* @__PURE__ */ (0, import_jsx_runtime.jsx)("option", { value: p.label, children: p.label }, p.id))
        }
      )
    ] }),
    (showAttachment || !hideAttachment) && /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: defaultStyles.fieldGroup, children: [
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { style: defaultStyles.label, children: "Attachments" }),
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)(
        "input",
        {
          type: "file",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime.jsx)("label", { htmlFor: "ticket-attachments", style: defaultStyles.fileButton, children: "+ Add Files" }),
      attachments.length > 0 && /* @__PURE__ */ (0, import_jsx_runtime.jsx)("div", { style: defaultStyles.fileList, children: attachments.map((file, index) => /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", { style: defaultStyles.fileItem, children: [
